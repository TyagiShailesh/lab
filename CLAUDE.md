...
- Docs: [README.md](README.md) has the full index. Key files: [bcachefs.md](bcachefs.md) (pool architecture + mount + module), [hardware.md](hardware.md), [network.md](network.md), [storage.md](storage.md), [gpu.md](gpu.md), [media.md](media.md), [thunderbolt.md](thunderbolt.md). Kernel build pipeline: [kernel/](kernel/). Runnable tools: [scripts/](scripts/).
